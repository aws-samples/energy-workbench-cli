...
export class AmplifyDeploy extends Construct {
  ...
  constructor(scope: Construct, id: string, props: AmplifyDeployProps) {
    ...
    this.amplifyApp = new Amplify.App(this, "AmplifyWebApp", {
      description: `Sample AWS Amplify Application for ${
    ...
    ); // adds support for amplify single page react application delivery
     ...
     */
    const amplifyAutoDeploy = new cr.AwsCustomResource(
      this,
      "AmplifyAutoDeploy",
      {
        onCreate: {
