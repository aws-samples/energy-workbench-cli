...
export class CognitoAuth extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CognitoProps) {
    ...
    const userPool = new UserPool(this, "UserPool", {
      ...
      // Invite Message
      userInvitation: {
        emailSubject: `Welcome to IoT ${Stack.of(this).stackName}`,
        emailBody:
          "Hello {username}, you have been invited to join ${Stack.of(this).stackName}! Your temporary password is {####}",
        smsMessage:
          "Hello {username}, your temporary password for AWS IoT EnergyKit is {####}",
      },
      // Verification Message
      userVerification: {
        emailSubject: "Verify your email for AWS IoT EnergyKit",
        emailBody:
          "Thanks for signing up for AWS IoT EnergyKit! Your verification code is {####}",
