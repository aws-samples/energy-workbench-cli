...
export class SolutionLambda extends lambda.Function {
  /**
  ...
  /**
   * Creates a Lambda Function that enables cdk_nag compliance through defaults
   ...
   * @param scope
   * @param id
   * @param SolutionLambdaProps
   */
  constructor(scope: Construct, id: string, props: SolutionLambdaProps) {
    super(scope, id, {
      ...props,
      /**
